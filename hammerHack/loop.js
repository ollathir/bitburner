...
var sHack = "/hammerHack/hack.js";
var sGrow =  "/hammerHack/grow.js";
var sWeaken =  "/hammerHack/weaken.js";


var hackAmt = 0.8;
var chanceToHack = 0.9;
var homeReserved = 50;
...
//	ns.print( `Finish at: H: ${convertMSToHHMMSS(timeToHack+tHack)} G: ${convertMSToHHMMSS(timeToGrow+tGrow)} W: ${convertMSToHHMMSS(curTime+tWeaken)}`);
	...
	for (var i = 0 ; i < myTargets.length ; i++ ) {
		if (myTargets[i].target=="sigma-cosmetics") { targnum = i; }
	}

	var myTarget = myTargets[targnum];
		{
